...
"""Testing suite for the PPOCRV6TinyRec model."""
...
class PPOCRV6TinyRecModelTester:
    def __init__(
        self,
        parent,
        batch_size=3,
    ...
    def get_config(self) -> PPOCRV6TinyRecConfig:
        backbone_config = {
...
@require_torch
class PPOCRV6TinyRecModelTest(ModelTesterMixin, PipelineTesterMixin, unittest.TestCase):
    all_model_classes = (PPOCRV6TinyRecForTextRecognition,) if is_torch_available() else ()
    pipeline_model_mapping = (
        {"image-feature-extraction": PPOCRV6TinyRecForTextRecognition} if is_torch_available() else {}
    )
    ...
    def setUp(self):
        self.model_tester = PPOCRV6TinyRecModelTester(self)
    ...
    @unittest.skip("PPOCRV6TinyRec does not has no attribute `hf_device_map`")
    def test_model_parallelism(self):
        pass

    @unittest.skip("PPOCRV6TinyRec does not has no function `get_input_embeddings`")
    def test_model_get_set_embeddings(self):
        pass

    @unittest.skip(reason="PPOCRV6TinyRec does not support attention")
